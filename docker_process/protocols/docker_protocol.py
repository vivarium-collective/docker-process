...
class DockerData(Node):
    image: String = field(default_factory=String)
...
class DockerProtocol(Protocol):
    data: DockerData = field(default_factory=DockerData)
...
def load_protocol(core, protocol: DockerProtocol, data):
